...
try:
 ...
 def UravxBuCwNMpYWTzKhPR(UravxBuCwNMpYWTzKhco,method='GET',data=UravxBuCwNMpYWTzKhPH):
  try:
   ...
   UravxBuCwNMpYWTzKhcg('koneksi terputus, tolong cek lagi koneksi internet anda')
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI("Tools nuyul ZcashClickBot ".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("WhatsApp : +6283824483217")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Facebook : https://www.facebook.com/rianto.rianto.16547008")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("dibuat : LILUNG PROJECT")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPq+"Youtube Channel : lilung project".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  if me.username=='bagas_q' or me.id==415792043 or me.id==611711558:
   ...
   try:
    ...
    pass
  UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'Subscribe lilung project')
